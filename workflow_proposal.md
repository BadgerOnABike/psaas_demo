...
---
<!-- no toc -->
1. [Develop outline for new administration proposal](#develop-outline-for-new-administration-proposal)
1. [Table of Contents](#table-of-contents)
1. [Preamble](#preamble)
1. [Repo Branch Structure](#repo-branch-structure)
   1. [Quick read on development workflows](#quick-read-on-development-workflows)
   1. [Where we want to be in the short term](#where-we-want-to-be-in-the-short-term)
   1. [Where we want to be in the long term](#where-we-want-to-be-in-the-long-term)
1. [New Release Schedule](#new-release-schedule)
1. [Bug fixes](#bug-fixes)
1. [New Features](#new-features)
1. [New Version Number Format](#new-version-number-format)
1. [Dev builds built by testers](#dev-builds-built-by-testers)
1. [Redmine Migration to Git Hub](#redmine-migration-to-git-hub)
   1. [Migrating Historical Redmine Data to Github](#migrating-historical-redmine-data-to-github)
1. [New Website as a management tool](#new-website-as-a-management-tool)
   1. [Moving forward: Github](#moving-forward-github)
1. [Two workflows - Simple and Advanced](#two-workflows---simple-and-advanced)
   1. [Simple Workflow - using website](#simple-workflow---using-website)
   1. [Advanced Workflow using Github](#advanced-workflow-using-github)
1. [Automatic Community Engagement](#automatic-community-engagement)
...
## Redmine Migration to Git Hub

### Migrating Historical Redmine Data to Github
...
## Automatic Community Engagement
