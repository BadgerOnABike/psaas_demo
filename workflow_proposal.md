...
- [3. Repo Branch Structure](#3-repo-branch-structure)
  - [3.1. Quick read on development workflows](#31-quick-read-on-development-workflows)
  - [3.2. Where we want to be in the short term](#32-where-we-want-to-be-in-the-short-term)
  - [3.3. Where we want to be in the long term](#33-where-we-want-to-be-in-the-long-term)
- [4. New Release Schedule](#4-new-release-schedule)
- [5. Bug fixes](#5-bug-fixes)
- [6. New Features](#6-new-features)
- [7. New Version Number Format](#7-new-version-number-format)
- [8. Dev builds built by testers](#8-dev-builds-built-by-testers)
- [9. Redmine Migration to Git Hub](#9-redmine-migration-to-git-hub)
  - [9.1. Migrating Historical Redmine Data to Github](#91-migrating-historical-redmine-data-to-github)
- [10. Licencing](#10-licencing)
  - [10.1. Pre-release licencing](#101-pre-release-licencing)
  - [10.2. Open source licenses](#102-open-source-licenses)
- [11. New Website as a management tool](#11-new-website-as-a-management-tool)
  - [11.1. Moving forward: Github](#111-moving-forward-github)
- [12. Two workflows - Simple and Advanced](#12-two-workflows---simple-and-advanced)
  - [12.1. Simple Workflow - using website](#121-simple-workflow---using-website)
  - [12.2. Advanced Workflow using Github](#122-advanced-workflow-using-github)
- [13. Community Engagement](#13-community-engagement)
...
## 9. Redmine Migration to Git Hub

### 9.1. Migrating Historical Redmine Data to Github
...
## 12. Two workflows - Simple and Advanced

### 12.1. Simple Workflow - using website
...
### 12.2. Advanced Workflow using Github
